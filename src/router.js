...
const router = createRouter({
  ...
  routes: [
    { path: '/', redirect: '/coaches', meta: {title: 'App'} },
    { path: '/coaches', component: CoachesList, meta: {title: 'App'} },
    {
      path: '/coaches/:id',
    ...
    { path: '/register', component: CoachRegistation, meta: {requiresAuth: true, title: 'App'} },
    { path: '/requests', component: RequestsReceived, meta: { requiresAuth: true, title: 'App' } },
    { path: '/auth', component: UserAuth, meta: {requiresUnauth: true ,title: 'App'}},
